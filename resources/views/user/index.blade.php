   ...
   .panel-heading {
    width: 80% !important;
      ...
      <div class="panel_view_details">
         <div class="table_p">
         <form action="{{route('user_profile_update')}}" id="form_edit"  method="post">
            @csrf
            <table class="tbl_profil">
               ...
               <tr>
                  ...
                  <td> <input type="password" class="input_prof"  name="mot_de_pass" id='pass' > </td>
               </tr>
               <tr>
                  <td class="td_1">Confirmer le mot de passe  :</td>
                  <td> <input type="password" class="input_prof" id='pass_confirm' > </td>
               </tr>
               <tr>
      ...
      <script src="{{asset('assets/js/edit_user.js')}}"></script>

            ...
            <div class="card">
               <div class="card-body ">
                  <form method="POST" action="{{ route('updateUser',$user->id) }}">
                     ...
                     <div class="row mb-3">
                        <label for="email" class="col-md-4 col-form-label text-md-end"> Gerer mes archives   </label>
                        <div class="col-md-6">
                        <input type="checkbox" id="vehicle1" name="gerer_archives" value="ok_archives" <?php if($user->gerer_archives){ echo 'checked'; }     ?>>
                        </div>
                     </div>
                     <div class="row mb-3">
                        <label for="email" class="col-md-4 col-form-label text-md-end">  configurer ma solution </label>
                        <div class="col-md-6">
                          <input type="checkbox" id="vehicle1" name="config_solution" value="ok_solution"    <?php if($user->config_solution){ echo 'checked'; }     ?> >
                        </div>
                     </div>

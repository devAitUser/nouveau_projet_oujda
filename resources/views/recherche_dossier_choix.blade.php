                        ...
                        <div class="form-group row">
                           ...
                           <div class="col-sm-6">
                              ...
                              <ul>
                                   ...
                                   <li class="link_menu__left" onclick="window.open('{{url('recherche_dossier')}}', '_self');">
                                       <span class="icon_menu_left">
                                       <img src="{{ asset('img_app/icons8-nouveau-produit-48.png') }}" style="width: 25px;">
                                       </span>
                                       <span class="label_menu _left"> Version numérique </span>
                                    </li>
                           ...
                           <div class="col-sm-6">
                                 ...
                                 recherche_physique
                                       <li class="link_menu__left" onclick="window.open('{{url('selectionner_entite_inventaire_recheche')}}', '_self');">
                                          <span class="icon_menu_left">
                                          <img src="{{ asset('img_app/room.png') }}" style="width: 25px;">
                                          </span>
                                          <span class="label_menu _left"> Version physique </span>
                                       </li>
